      ...
      <div className="min-h-full bg-[#f3f4f6]">
        <div className="max-w-2xl mx-auto px-6 py-10">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Suporte</h1>
          ...
          {/* Tabs */}
          <div className="flex gap-2 mb-8 p-1 bg-gray-200/70 rounded-2xl">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                ...
                <div className="flex flex-col gap-3">
                  {contacts.map((contact) => (
                    <a
                      ...
                      className="group flex items-center gap-4 p-4 bg-white rounded-2xl border border-gray-100 hover:border-[#25D366]/40 hover:shadow-md transition-all"
                    >
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#ccff00]/50 focus:border-[#ccff00] disabled:bg-gray-100 disabled:text-gray-400 transition-all"
                />
                <label className="flex items-center gap-2 mt-3 cursor-pointer select-none">
                  ...
                  />
                  <span className="text-sm text-gray-600">Prefiro nao informar (enviar anonimo)</span>
                </label>
              </div>
              ...
              {/* Relato */}
              <div className="mb-6">
                <label className="block text-sm font-semibold text-gray-700 mb-2">O que esta acontecendo?</label>
                <textarea
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                  rows={5}
                  placeholder="Descreva em detalhes o que voce quer relatar. Se for sobre outro usuario, informe o nome/usuario dele."
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#ccff00]/50 focus:border-[#ccff00] resize-none transition-all"
                />
              </div>
